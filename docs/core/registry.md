...
```text
registry/
├── k8s # Kubernetes Design Patterns
│   ├── doc
│   │   └── <pattern-name>.md
│   └── patterns
│       ├── <pattern-name>.yaml
│       ├── <pattern-name-2>.yaml
│       └── ...
├── custom-domain # Custom Patterns for specific domains (e.g., krateo, business-specific)
│   ├── doc
│   │   └── ...
│   ├── patterns
│   │   └── ...
...
- `patterns/`: Contains the Pattern-as-Code YAML manifests that define the patterns, their detection logic, and remediation strategies.
